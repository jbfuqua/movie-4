...
export const AUDIENCE_SCHEMA = {
    ...
    properties: {
        ...
        title: {
            type: 'string',
            description: 'The FINAL title. If the original was good, return it unchanged. If not, this is the better one. Avoid the shape THE + [participle or mood adjective] + [noun] ("The Listening Room", "The Standing Water") — it is the weak, portentous default and it sells nothing.'
        },
        tagline: {
            type: 'string',
            description: 'The FINAL tagline. If the original was good, return it unchanged. If not, this is the better one. Use no em-dash (—), no en-dash (–) and no semicolon (;) — a full stop or a comma reads stronger.'
        },
        changed: {
            type: 'boolean',
...
export function audiencePrompt(concept, tone) {
    ...
    return [
        ...
        '',
        // The rewrite was coming out generic because JOB TWO had no voice — just
        // "you are the copywriter". The tone's persona is the same one who wrote
        // this studio's copy in the first place; hand the rewrite that voice and
        // that standard, or it drifts below the copy it is replacing.
        'Put on your other hat now — the studio copywriter who wrote this studio\'s copy in the first place. This is who you are, and the standard you hold yourself to:',
        toneRules.persona,
        '',
