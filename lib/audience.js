...
export const AUDIENCE_SCHEMA = {
    ...
    properties: {
        ...
        title: {
            type: 'string',
            description: 'The FINAL title. If the original was good, return it unchanged. If not, this is the better one. NEVER of the shape THE + [participle or mood adjective] + [noun] ("The Listening Room", "The Standing Water") — that is checked in code and rejected outright.'
        },
        tagline: {
            type: 'string',
            description: 'The FINAL tagline. If the original was good, return it unchanged. If not, this is the better one. It must contain NO em-dash (—), NO en-dash (–) and NO semicolon (;) — this is checked in code and rejected outright. Use a full stop or a comma.'
        },
        changed: {
            type: 'boolean',
