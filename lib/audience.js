...
export const AUDIENCE_SCHEMA = {
    ...
    properties: {
        ...
        title: {
            type: 'string',
            description: 'The FINAL title. If the original title is good, return it unchanged — do not rewrite a working title just to look busy. Only if it genuinely falls flat, replace it with a stronger, real-sounding period-genre title.'
        },
        tagline: {
            type: 'string',
