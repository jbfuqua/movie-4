...
export function conceptPrompt({ genre, era, plot, intensity, avoidTitles = [], seed }) {
    ...
    lines.push(
        intensity === 'hardcore'
            ? '- Tone: as intense as the decade would actually permit. Push to the edge of what that era could put on a poster, and no further — the limit is the period\'s own, not a modern one.'
