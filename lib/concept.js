...
const EXEMPLARS = [
    {
        ...
        why: 'one loaded noun for a title; a four-word tagline that gives the reader an order, present tense, with teeth.'
    },
    {
        title: 'OVERNIGHT',
        tagline: 'You leave the hall light on for the children. It isn\'t for them.',
        why: 'a flat everyday word made sinister; the line takes a small domestic comfort and turns it into a warning aimed at you.'
    },
    {
        title: 'FREE REFILLS',
        tagline: 'The soda fountain became self-aware on a Tuesday. Management is handling it.',
        why: 'an absurd premise delivered with a straight corporate face — the comedy is entirely in the deadpan, never a wink or a pun.'
    }
];
...
export function copyRules(tone) {
    ...
    const lines = [
        ...
        '',
        'Write to that bar.',
        '- THE TITLE names the threat or the sensation: a loaded noun, said flat and left to bite. "Barbarian" is one word and it works. Not the setting, not the weather, not a mood — if it could be a sign on a door or the name of a landscape, it is a caption, not a title.',
