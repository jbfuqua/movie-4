...
const PREMISE_EXEMPLARS = [
    'A deep-sea drilling crew hauls up something that keeps unfolding after they think they have seen all of it, and by morning it is wearing the faces and the voices of the men it has already taken.',
    'Every night on the graveyard shift at a fogged-in interstate rest stop, a figure in a butcher\'s apron works through the stranded travellers one by one, and he is always waiting at the next rest stop before they arrive.',
    'An alien marooned in a desert radio-telescope array feeds on human thought, and with every mind it empties it grows a new mouth, a stolen skill, and a sharper idea of how to get to the city.'
];
