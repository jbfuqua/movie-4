...
export function copyRules(tone) {
    ...
    const lines = [
        ...
        '',
        'Write to that bar.',
        '- THE TITLE names the threat or the sensation and is left to bite. Vary the length — "Barbarian" is one loaded word, "Don\'t Answer It" is a small sentence, both work. Do not default to a single noun; reach for whatever hits hardest. Not the setting, not the weather, not a mood — if it could be a sign on a door or the name of a landscape, it is a caption, not a title.',
